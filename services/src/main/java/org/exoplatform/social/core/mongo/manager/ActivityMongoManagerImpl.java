 ...
 */
package org.exoplatform.social.core.mongo.manager;
...
/**
 * Class ActivityManagerImpl extends ActivityManagerImpl.
 *
 */
public class ActivityMongoManagerImpl extends ActivityManagerImpl {
  /** Logger */
  private static final Log               LOG = ExoLogger.getLogger(ActivityMongoManagerImpl.class);
   ...
   */
  public ActivityMongoManagerImpl(ActivityStorage activityStorage, IdentityManager identityManager) {
